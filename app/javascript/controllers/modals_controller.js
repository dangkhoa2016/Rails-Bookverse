...
export default class extends Controller {
  ...
  initModal() {
    ...
    this.modal = new coreui.Modal(this.element);
    const oldHide = this.modal.hide;
    this.modal.hide = () => {
      const event = new CustomEvent('modals-controller:before-close', {
        detail: {},
      });
      this.element.dispatchEvent(event);
      oldHide.call(this.modal);
    };
  }
