module ApplicationHelper
  NAV_MENUS = [
    ...
    { id: 4, name: 'Publishers', path: :publishers },
    { id: 5, name: 'Categories', path: :categories },
    { id: 6, name: 'Reviews', path: :reviews },
    { id: 7, name: 'Libraries', path: :libraries },
    { id: 8, name: 'BookLoans', path: :book_loans },
    { id: 9, name: 'Members', path: :members },
    { id: 10, name: 'Author Profiles', path: :author_profiles },
