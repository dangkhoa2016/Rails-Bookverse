...
class BookLoansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_loan" do
    assert_difference("BookLoan.count") do
      post book_loans_url, params: { book_loan: { active: @book_loan.active, book_id: @book_loan.book_id, borrowed_on: @book_loan.borrowed_on, member_id: @book_loan.member_id, returned_on: @book_loan.returned_on, status: @book_loan.status } }
    end
  ...
  test "should update book_loan" do
    patch book_loan_url(@book_loan), params: { book_loan: { active: @book_loan.active, book_id: @book_loan.book_id, borrowed_on: @book_loan.borrowed_on, member_id: @book_loan.member_id, returned_on: @book_loan.returned_on, status: @book_loan.status } }
